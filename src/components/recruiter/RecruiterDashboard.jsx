...
function RecruiterDashboard() {
  ...
  return (
    <div className="flex w-full bg-gradient-to-br from-[#eef2ff] via-white to-[#f8fafc] dark:from-[#0f172a] dark:to-[#020617] transition min-h-screen">
      {/* MAIN */}
      <div className="flex-1 flex flex-col">
        {/* NAVBAR */}
        <header className="flex justify-between items-center px-8 h-16 bg-[#f7f9fb] border-b">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                  <div className="flex justify-between mb-4">
                    ...
                    <span className="text-[#24389c] text-sm cursor-pointer">
                      View All
                    </span>
                  </div>
